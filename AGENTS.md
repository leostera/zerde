...
- prefer feature-first corpus names such as `null.json`, `empty.toml`, `array_float.yaml`, and `object_single.cbor`
- corpus tests are generated from `tests/corpus/json`, `tests/corpus/toml`, `tests/corpus/yaml`, and `tests/corpus/cbor`
