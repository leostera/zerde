...
- benchmark history lives in `bench/BIN.md`, `bench/BSON.md`, `bench/CBOR.md`, `bench/JSON.md`, `bench/MSGPACK.md`, `bench/TOML.md`, `bench/WASM.md`, `bench/YAML.md`, and `bench/ZON.md`
